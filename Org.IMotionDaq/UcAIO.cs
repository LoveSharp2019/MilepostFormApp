...
namespace Org.IMotionDaq
{
    public partial class UcAIO : UserControl
    {
        ...
        delegate void dgSetModule(IPlatModule_AIO module, string[] aiNames, string[] aoNames);
        public void SetModuleInfo(IPlatModule_AIO module, string[] aiNames, string[] aoNames)
        {
            if (InvokeRequired)
            {
                BeginInvoke(new dgSetModule(SetModuleInfo), new object[] { module, aiNames, aoNames });
                return;
            }
