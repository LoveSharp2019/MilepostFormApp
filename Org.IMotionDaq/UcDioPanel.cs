...
{
    public partial class UcDioPanel : UcRealTimeUI
    {
        public UcDioPanel()
        {
            InitializeComponent();
        ...
        public void AddIO(IPlatModule_DIO module, int ioIndex, string name = null, LampButton.LColor offColor = LampButton.LColor.Gray, LampButton.LColor onColor = LampButton.LColor.Green)
        {
            if (name == null)
        ...
        public void RemoveIO(IPlatModule_DIO module, int ioIndex)
        {
        ...
        public void RemoveAllDIO()
        {
            if (InvokeRequired)
            {
                BeginInvoke(new Action(RemoveAllDIO));
                return;
            }
            ioInfos.Clear();
        ...
        void AdjustIOView()
        {
            if (InvokeRequired)
            {
                BeginInvoke(new Action(AdjustIOView));
                return;
            }
            int i = 0;
        ...
        class DIOInfo
        {
            internal DIOInfo(IPlatModule_DIO module, int ioIndex)
            {
                Module = module;
                Index = ioIndex;
            }

            internal IPlatModule_DIO Module { get; set; }
