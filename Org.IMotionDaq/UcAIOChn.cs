...
namespace Org.IMotionDaq
{
    public partial class UcAIOChn : UserControl
    {
        ...
        [Category("属性"), Description("IO名称"), Browsable(true)]
        ...
        [Category("属性"), Description("IO数值"), Browsable(true)]
        ...
        [Category("属性"), Description("编辑IO名称使能"), Browsable(true)]
        ...
        IPlatModule_AIO _aio = null;
        int _ioIndex = 0;
        bool _isAo = false;
        string _ioName = "";
        delegate void DgSetIOInfo(IPlatModule_AIO aio, int ioIndex, bool isAo, string name);
        public void SetIOInfo(IPlatModule_AIO aio, int ioIndex, bool isAo, string name)
        {
            if (InvokeRequired)
            {
                BeginInvoke(new DgSetIOInfo(SetIOInfo), new object[] { aio, ioIndex, isAo, name });
                return;
            }
            IOName = name;
            _isAo = isAo;
        ...
        public IPlatModule_AIO AIOModule { get { return _aio; } }
        ...
        public void UpdateIO()
        {
            ...
            tbIOValue.BackColor = SystemColors.Control;
